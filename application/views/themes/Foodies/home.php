...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/grocery.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Grocery Online Belanja Lebih Mudah</h1>
            <h2 class="subheading mb-4">Barang Dan Produk terbaik kami siapkan</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/sqKPty.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Ragam Produk Yang Anda Butuhkan</h1>
            <h2 class="subheading mb-4">Barang Dan Produk terbaik kami siapkan</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
